...
CoolProp::Plot::TPLimits resolve_tplimits(const std::string& name)
{
    ...
    if (upper == "NONE") return CoolProp::Plot::TPLimits::None;
    if (upper == "DEF" || upper == "DEFAULT") return CoolProp::Plot::TPLimits::Def;
    if (upper == "ACHP") return CoolProp::Plot::TPLimits::Achp;
    if (upper == "ORC") return CoolProp::Plot::TPLimits::Orc;
...
std::string tplimits_to_string(CoolProp::Plot::TPLimits limits)
{
    switch (limits)
    {
        case CoolProp::Plot::TPLimits::None: return "None";
        case CoolProp::Plot::TPLimits::Def: return "Def";
        case CoolProp::Plot::TPLimits::Achp: return "Achp";
        case CoolProp::Plot::TPLimits::Orc: return "Orc";
        default: return "Def";
    }
}
